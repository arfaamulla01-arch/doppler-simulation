...
export default function Home() {
  ...
  return <div className="site-shell">
    <header className="site-header"><a className="brand" href="#top" aria-label="Doppler Lab home"><img src={`${import.meta.env.BASE_URL}doppler-logo.png`} alt="" /><span>Doppler<span>Lab</span></span></a><div className="header-context"><span>Class 11–12 Physics</span><i /><span>Interactive acoustic experiment</span></div><a className="header-link" href="#concept">Concept note <ChevronRight size={15} /></a></header>
    <main id="top">
